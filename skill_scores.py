...
# truth
end_true = np.loadtxt(f'/work/sc130/sc130/akneale/96_reduced/data/1000_1000_10000/end_pos.csv', delimiter=',')
...
X_model = np.loadtxt(f'/work/sc130/sc130/akneale/96_reduced/96_reduced_mixed_diag/models/NC32_e7_5e-6_131072_100_e7_8_t=e2e5_d=e2e5/end_arr.csv', delimiter=',')  # Shape: (n_traj, n_model_repeats * x_dim)
...
# ML
# dimension (n_traj,n_model_repeats*x_dim)
X_model = np.loadtxt(f'/work/sc130/sc130/akneale/96_reduced/96_reduced_mixed_diag/models/ML_NC32_e7_5e-6_131072_100_e7_8_t=e2e5_d=e2e5/end_arr.csv', delimiter=',')  # Shape: (n_traj, n_model_repeats * x_dim)
...
# SD
# dimension (n_traj,n_model_repeats*x_dim)
X_model = np.loadtxt(f'/work/sc130/sc130/akneale/96_reduced/96_reduced_sing_diag/models/NC1_e7_2e-6_131072_100_e7_8_t=e2e5_d=e2e5/end_arr.csv', delimiter=',')  # Shape: (n_traj, n_model_repeats * x_dim)
...
# SL
# dimension (n_traj,n_model_repeats*x_dim)
X_model = np.loadtxt(f'/work/sc130/sc130/akneale/96_reduced/96_reduced_sing_lower/full/models/NC1_e7_5e-5_16384_100_e7_8_t=e2e5_d=e2e5/end_arr.csv', delimiter=',')  # Shape: (n_traj, n_model_repeats * x_dim)
