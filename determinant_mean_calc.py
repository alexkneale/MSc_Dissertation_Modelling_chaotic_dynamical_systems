...
print('sd = '+str(sd))
'''
sl_arr = np.loadtxt(f'/work/sc130/sc130/akneale/96_reduced/96_reduced_sing_lower/full/models/NC1_e7_5e-5_16384_100_e7_8_t=e2e5_d=e2e5/determinant.csv', delimiter=',')
sl = np.mean(sl_arr)
print('sl = '+str(sl))
