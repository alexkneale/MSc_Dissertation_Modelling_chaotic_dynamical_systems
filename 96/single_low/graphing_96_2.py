...
MODEL_DIR = (f"/work/sc130/sc130/akneale/96/single_low/models/NC1_e7_e-5_131072_10_e7_8_32_t=e2e5_d=e2e5_5.0_10.0_2.0_20.0/")
...
histogram_96, bins_96 = np.histogram(traj_96.flatten(), bins=3000, density=True)
midx_96 = (bins_96[:-1] + bins_96[1:]) / 2

histogram_nn, bins_nn = np.histogram(traj_nn.flatten(), bins=3000, density=True)
...
plt.plot(midx_nn_valid, histogram_nn_valid, '--', label='SL Model')
