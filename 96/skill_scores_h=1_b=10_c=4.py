...
# truth
end_true = np.loadtxt(f'/work/sc130/sc130/akneale/96/data/1000_1000_10000_1.0_10.0_4.0_20.0/end_pos.csv', delimiter=',')
...
X_model = np.loadtxt(f'/work/sc130/sc130/akneale/96/mixed_diag/models/NC32_e7_1e-5_131072_100_e7_8_32_t=e2e5_d=e2e5_1.0_10.0_4.0_20.0/end_arr.csv', delimiter=',')  # Shape: (n_traj, n_model_repeats * x_dim)
...
# ML
# dimension (n_traj,n_model_repeats*x_dim)
X_model = np.loadtxt(f'/work/sc130/sc130/akneale/96/mixed_low/full_model/models/NC32_e7_e-5_131072_10_e7_8_32_t=e2e5_d=e2e5_1.0_10.0_4.0_20.0/end_arr.csv', delimiter=',')  # Shape: (n_traj, n_model_repeats * x_dim)
...
# SD
# dimension (n_traj,n_model_repeats*x_dim)
X_model = np.loadtxt(f'/work/sc130/sc130/akneale/96/single_diag/models/NC1_e7_e-5_131072_100_e7_8_32_t=e2e5_d=e2e5_1.0_10.0_4.0_20.0/end_arr.csv', delimiter=',')  # Shape: (n_traj, n_model_repeats * x_dim)
...
# SL
# dimension (n_traj,n_model_repeats*x_dim)
X_model = np.loadtxt(f'/work/sc130/sc130/akneale/96/single_low/models/NC1_e7_5e-5_131072_100_e7_8_32_t=e2e5_d=e2e5_1.0_10.0_4.0_20.0/end_arr.csv', delimiter=',')  # Shape: (n_traj, n_model_repeats * x_dim)
...
filename = 'skill_scores_h=1_b=10_c=4.csv'
