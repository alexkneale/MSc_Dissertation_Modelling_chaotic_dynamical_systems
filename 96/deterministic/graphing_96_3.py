...
#lorenz_96_data_display(traj_96,traj_nn, max_lag_temp,max_lag_space,dt,output_dir,n_particles,K,J,n_steps_train,train_particles,test_steps,test_particles)
print('success')
