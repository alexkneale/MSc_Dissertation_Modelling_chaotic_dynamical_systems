...
def load_scalers(N_C, n_steps_train_str, LEARNING_RATE_str, BATCH_SIZE, PATIENCE, test_steps_str,K,train_particles_str,test_particles_str):
    ...
    with open(f"/work/sc130/sc130/akneale/96_reduced/data/{n_steps_train_str}_{test_steps_str}_{K}_{train_particles_str}_{test_particles_str}/Xscaler.pkl", "rb") as file:
        Xscaler = pickle.load(file)

    with open(f"/work/sc130/sc130/akneale/96_reduced/data/{n_steps_train_str}_{test_steps_str}_{K}_{train_particles_str}_{test_particles_str}/Yscaler.pkl", "rb") as file:
