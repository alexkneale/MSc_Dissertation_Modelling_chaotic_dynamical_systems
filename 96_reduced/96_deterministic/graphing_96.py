...
## 96
def lorenz_96_data_display(traj_96,traj_nn, test_error, validation_error,  max_lag_temp,max_lag_space,dt,output_dir,n_particles):
...
lorenz_96_data_display(traj_96,traj_nn, test_error, validation_error,  max_lag_temp,max_lag_space,dt,output_dir,n_particles)
print('success')
