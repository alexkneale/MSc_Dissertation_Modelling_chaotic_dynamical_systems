...
plt.title('Distribution of $x$, MD Model')
plt.xlabel('$x$')
plt.ylabel('$p(x)$')
plt.legend()
plt.grid(True)
...
plt.plot(midx_63,histogram_63,'--',label='Truth')
plt.plot(midx_nn,histogram_nn,'--',label='MD Model')
plt.title('Distribution of $y$, MD Model')
plt.xlabel('$y$')
plt.ylabel('$p(y)$')
plt.legend()
plt.grid(True)
...
plt.plot(lags, autocorr_x_nn, marker='v',label='MD Model')
...
plt.plot(lags, autocorr_y_nn, marker='v',label='MD Model')    
...
plt.plot(lags, autocorr_z_nn, marker='v',label='MD Model')
