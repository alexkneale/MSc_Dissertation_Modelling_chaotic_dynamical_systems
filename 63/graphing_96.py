...
MODEL_DIR = (f"models/2_NC{N_C}_{n_steps_train_str}_{LEARNING_RATE_str}_{BATCH_SIZE}_{PATIENCE}_{test_steps_str}_{K}_{test_particles_str}/")
MODEL_DIR_MOTHER =  (f"models/NC{N_C}_{n_steps_train_str}_{LEARNING_RATE_str}_{BATCH_SIZE}_{PATIENCE}_{test_steps_str}_{K}_{test_particles_str}/")
...
traj_96 = np.loadtxt(f'{MODEL_DIR_MOTHER}traj_96.csv', delimiter=',')
...
# load the CSV file
file_path = f'{MODEL_DIR_MOTHER}log.csv'
...
plt.title('Temporal Autocorrelation of $x_i$, MD Model')
plt.xlabel('Lag (MTU)')
plt.ylabel('Temporal Autocorrelation')
plt.legend()
plt.grid(True)
...
plt.title('Spatial Autocorrelation of $x_i$, MD Model')
