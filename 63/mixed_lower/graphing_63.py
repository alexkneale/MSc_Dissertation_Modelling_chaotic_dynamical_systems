...
autocorr_x_63 = pd.read_csv(f'{MODEL_DIR}/temp_autocorr_96_x.csv',header=None)
autocorr_x_63.squeeze()
autocorr_y_63 = pd.read_csv(f'{MODEL_DIR}/temp_autocorr_96_y.csv',header=None)
autocorr_y_63.squeeze()
autocorr_z_63 = pd.read_csv(f'{MODEL_DIR}/temp_autocorr_96_z.csv',header=None)
...
# temporal autocorrelation
autocorr_x_nn = pd.read_csv(f'{MODEL_DIR}/temp_autocorr_nn_x.csv',header=None)
autocorr_x_nn.squeeze()
autocorr_y_nn = pd.read_csv(f'{MODEL_DIR}/temp_autocorr_nn_y.csv',header=None)
autocorr_y_nn.squeeze()
autocorr_z_nn = pd.read_csv(f'{MODEL_DIR}/temp_autocorr_nn_z.csv',header=None)
...
plt.title('Distribution of $x$, ML Model')
plt.xlabel('$x$')
plt.ylabel('$p(x)$')
plt.legend()
plt.grid(True)
...
plt.plot(midx_63,histogram_63,'--',label='Truth')
plt.plot(midx_nn,histogram_nn,'--',label='ML Model')
plt.title('Distribution of $y$, ML Model')
plt.xlabel('$y$')
plt.ylabel('$p(y)$')
plt.legend()
plt.grid(True)
...
plt.figure(4)
lags = np.arange(max_lag+1)*dt*10
plt.plot(lags, autocorr_x_63, marker='o',label='Truth')
plt.plot(lags, autocorr_x_nn, marker='v',label='ML Model')
...
plt.plot(lags, autocorr_y_nn, marker='v',label='ML Model')    
...
plt.plot(lags, autocorr_z_nn, marker='v',label='ML Model')
